...
public interface IPromotionUsageService
{
    ...
    Task<IReadOnlyList<PromotionUsageRecord>> SearchUsageRecordsAsync(PromotionUsageRecordQuery query, CancellationToken cancellationToken = default);
    ...
    Task<OperationResult> UpdateUsageRecordAsync(UpdatePromotionUsageRecordRequest request, CancellationToken cancellationToken = default);
